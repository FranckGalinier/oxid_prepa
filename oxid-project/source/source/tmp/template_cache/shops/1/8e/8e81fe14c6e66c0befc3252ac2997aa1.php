...
/* @__main__/user.html.twig */
class __TwigTemplate_6593fc3fa02f87965c422dd7aea5c8dd extends Template
{
    private $source;
    private $macros = [];
...
<frameset  rows=\"40%,*\" border=\"0\" onload=\"document.getElementById('edit').src='";
    ...
    {
        return "@__main__/user.html.twig";
    }
    ...
    {
        return new Source("", "@__main__/user.html.twig", "/var/www/html/source/Application/views/admin_twig/tpl/user.html.twig");
    }
}
